        ...
        <div class="tab-pane active" id="huil">
            ...
            <div class="uk-slidenav-position uk-margin">
                <ul class="uk-slideset uk-grid uk-flex-center uk-grid-width-1-1 uk-grid-width-medium-1-4">
                    <li class="uk-active" style="" data-uk-filter="test-a"><a  href="#modal" data-uk-modal=""><img data-holder-rendered="true" class="img-responsive center-block"  src="<?php bloginfo('template_url')?>/img/produit/boit1.png" alt="" height="200" width="100"></a></li>
            ...
            <div style="display: none; overflow-y: auto;" aria-hidden="false" id="modal" class="uk-modal uk-open">
                <div class="uk-modal-dialog uk-modal-dialog-large posmodal">
                    <button type="button" class="uk-modal-close uk-close"></button>
                     <div class="uk-grid">
                     	<div class="uk-width-2-10">
                     		<img  class="img-responsive "  src="<?php bloginfo('template_url')?>/img/produit/boit1.png" alt="" height="100" width="100">
                     	</div>
                     	<div class="uk-width-8-10">
                     		<div class="uk-modal-header">
		                        <h3 class="modaltitle">Huile de mais 0.75L</h3>
		                    </div>
		                    <p class="txtpoup">L'huile de maïs est une huile de couleur ambrée des plus utilisées au monde, obtenue à partir de germes de maïs.<br> 
		                    C'est une huile très riche en graisses poly insaturées et contient des acides gras qui permettent de lutter contre le cholestérol. </p>
		                    <h4 class="modaltxt colormodalgreen">Utilisation:</h4>
		                    <p class="txtpoup">
		                    Assaisonnement - Cuisson - Pâtisserie - Friture L'huile de maïs Jadida s'utilise aussi bien à froid,<br> 
		                    pour les assaisonnements ou marinades, qu'à chaud pour les grillades, cuissons au four, <br>
		                    pâtisseries. Son goût délicat apporte une saveur inattendue aux marinades de poissons blancs <br>
		                    (dorade, loup, sole, ...), aux légumes (haricots verts, pommes de terre, champignons, ...), aux pâtisseries (pâtes à tarte, crêpes).
		                    </p>
		                    <h4 class="modaltxt colormodalred">Informations Nutritionnelles:</h4>
		                    <p class="txtpoup">100 g d'huile de Maïs Jadida apportent en moyenne : Cholestérol 0% / Protéines 0 g / Glucides 0 g / Acides gras saturés 14 g / Acides gras mono insaturés 30 g / Acides gras poly insaturés 56 g</p>
                     	</div>
                     </div>
                </div>
            </div>
