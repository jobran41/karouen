                           ...
                           foreach ($parents as $parent) {   
                               $fils=parampost($parent[1]);
                                ...
                                echo ' <li data-uk-filter='.$parent[1].'>' 
                                   . '<div class="cadre2 text-center"><img class="img-responsive center-block imgdefault" src='.$fil[1].' alt=""  height="" width="700" /> <div class="uk-grid switchprod" style="display: none;">
                        ...
                        <ul class="uk-slideset uk-grid uk-flex-center uk-grid-width-1-1 uk-grid-width-medium-1-1"> 
                           ...
                           foreach ($parents as $parent) { 
                               ...
                               //print_r($fils); 
                                foreach ($fils as $fil) {
                                echo ' <li data-uk-filter='.$parent[1].'>' 
                                   . '<div class="cadre2 text-center"><img class="img-responsive center-block imgdefault" src='.$fil[1].' alt=""  height="" width="700px" /><div class="uk-grid switchprod" style="display: none;">
                                                     <div class="uk-width-7-10">
                                                       <div class="uk-modal-header"> 
                                                           <h3 class="modaltitle"> 
                                                             '.$fil[0].'
                        ...
                        <ul class="uk-slideset uk-grid uk-flex-center uk-grid-width-1-1 uk-grid-width-medium-1-1"> 
                           ...
                           foreach ($parents as $parent) {    
                               $fils=parampost($parent[1]); 
                                foreach ($fils as $fil) {
                                echo ' <li data-uk-filter='.$parent[1].'>' 
                                   . '<div class="cadre2 text-center"><img class="img-responsive imgdefault center-block" src='.$fil[1].' alt=""  height="" width="700" /><div class="uk-grid switchprod " style="display: none;">
                                                     <div class="uk-width-7-10">
                                                       <div class="uk-modal-header">
                                                           <h3 class="modaltitle"> 
                                                             '.$fil[0].'
                               ...
                               $fils=parampost($parent[1]);
                                ...
                                echo ' <li data-uk-filter='.$parent[1].'>' 
                                   . '<div class="cadre2 text-center">'
                                        . '<img class="img-responsive center-block imgdefault" src='.$fil[1].' alt=""  height="" width="700px" /><div class="uk-grid switchprod" style="display: none;">  
                                                     <div class="uk-width-7-10">
                                                       <div class="uk-modal-header">
                                                           <h3 class="modaltitle"> 
                                                             '.$fil[0].'
                        ...
                        <ul class="uk-slideset uk-grid uk-flex-center uk-grid-width-1-1 uk-grid-width-medium-1-1"> 
                           ...
                           foreach ($parents as $parent) {   
                               $fils=parampost($parent[1]);
                                foreach ($fils as $fil) {
                                echo ' <li data-uk-filter='.$parent[1].'>'  
                                   . '<div class="cadre22  text-center"><img class="img-responsive center-block imgdefault" src='.$fil[1].' alt=""  height="" width="700" /><div class="uk-grid switchprod" style="display: none;">
                                                     <div class="uk-width-7-10">
                                                       <div class="uk-modal-header">
                                                           <h3 class="modaltitle"> 
                                                             '.$fil[0].'
